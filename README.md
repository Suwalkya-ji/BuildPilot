...
- **🔐 Secure Authentication**: JWT authentication with password hashing (`bcrypt`) and cookie management.
...
│   │   ├── components/         # UI Components (Landing, Builder, Editor)
...
│   │   ├── services/           # AI, Embedding, Qdrant & Generation services
...
cd server
cp .env.example .env
# Open .env and add your MONGODB_URI, GROQ_API_KEY, and HF_API_KEY
